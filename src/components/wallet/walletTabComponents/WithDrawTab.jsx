    ...
    <div className="p-8 rounded-[20px] nrCustomBgDeposite">
      <form onSubmit={handleSubmit(onSubmit)}>
        <div>
          ...
          <div
            className={`nr_customInputBox mt-[15px] flex gap-[14px] ${
              errors.withdrawAmount && "border-2 border-red-400"
            }`}
          >
            <div>
              <svg
          ...
          <div className="mt-2">
            <h3 className="text-[#798090] text-[16px] leading-6 font-exo">
              Available Balance <span className="text-[#0F0]">$230</span>
            </h3>
          </div>
        </div>
        ...
        <div className="mt-[28px]">
          ...
          <div
            className={`nr_customInputBox mt-[15px] flex gap-[14px] ${
              errors.withdrawWalletNumber && "border-2 border-red-400"
            }`}
          >
            <input
              {...register("withdrawWalletNumber", { required: true })}
              name="withdrawWalletNumber"
              id="withdrawWalletNumber"
              className="w-[100%] outline-0 [&::-webkit-inner-spin-button]:appearance-none 
                        [&::-webkit-outer-spin-button]:appearance-none 
                        [-moz-appearance:textfield]"
              type="number"
        ...
        <div className="mt-[28px]">
          ...
          <div
            className={`nr_customInputBox mt-[15px] flex gap-[14px] ${
              errors.withdrawAccountNumber && "border-2 border-red-400"
            }`}
          >
            <input
              {...register("withdrawAccountNumber", { required: true })}
